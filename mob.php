...
<body background="f.jpg" bgcolor=efefef link=red vlink=red><center><h3><span style="color:gray">Web based, DYNAMIC <span style="color:#9c353a">PORT SCANNER</span></span></h3>
<form method="post">
